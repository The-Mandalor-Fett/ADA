...
int main(int argc, char const *argv[])
{
    ...
    int *arreglo = (int*)malloc(tamanio*sizeof(int)); // PARA PEDIR EL TAMAÑO DEL ARRAY ES NECESARIO USAR MEMORIA DINÁMICA
    numerosAleatorios(arreglo,tamanio); //MANDA A LLAMAR A LA FUNCIÓN numerosAleatorios
    ...
    printf("\n \n");
    ordenamientoInsercion(arreglo,tamanio); // MANDA A LLAMAR A LA FUNCIÓN ordenamientoInsercion
